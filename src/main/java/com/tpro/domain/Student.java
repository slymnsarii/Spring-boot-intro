...
public class Student {
	...
	@NotNull(message = "first name can not be null") // nul deger olmasini istemiyorsam
	@NotBlank(message = "last name can not be white space") //bosluk karakteri girmesin diye
	@Size(min = 3,max = 25, message = "First name '${validetedValue}' must be between{min} and {max} long")
	@Column(nullable = false, length=25)//kullandigimiz field'lerin tabloda bir column'a denk gelmesini istiyorsam
